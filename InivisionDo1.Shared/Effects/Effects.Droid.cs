...
namespace Effects.Droid
{
    ...
    public class ShadowEffect : BaseEffect
    {
        ...
        {
            base.get_Container();
            return Build.VERSION.get_SdkInt() >= 21;
        }

        protected override void OnAttachedInternal()
        {
            this._originalElevation = base.get_Container().get_Elevation();
            this.UpdateShadow();
        }

        protected override void OnDetachedInternal()
        {
            base.get_Container().set_Elevation(this._originalElevation);
            if (this._originalBackground != null && base.get_Control().get_Background() == null)
            {
                base.get_Control().set_Background(this._originalBackground);
            }
        }
        ...
        protected override void OnElementPropertyChanged(PropertyChangedEventArgs args)
        {
            ...
            if (args.get_PropertyName() == ThemeEffects.ShadowProperty.get_PropertyName() || args.get_PropertyName() == ThemeEffects.ShadowSizeProperty.get_PropertyName())
            {
                this.UpdateShadow();
            }
        }
        ...
        {
            float shadowSize = (float)ThemeEffects.GetShadowSize(base.get_Element());
            if (shadowSize < 0f)
            {
                if (base.get_Control() != null && base.get_Control().get_Background() != null)
                {
                    this._originalBackground = base.get_Container().get_Background();
                    base.get_Control().set_Background(null);
                }
                return;
            }
            if (this._originalBackground != null && base.get_Control().get_Background() == null)
            ...
            base.get_Container().set_Elevation(shadowSize * base.get_Container().get_Resources().get_DisplayMetrics().get_Density());
        }
    }
